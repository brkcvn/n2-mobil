    ...
    <div>
      ...
      >
        <div class="w-6 h-5 flex flex-col justify-between">
          <span 
            class="w-full h-0.5 bg-primary_dark_blue block transition-all duration-300"
            :class="{ 'rotate-45 mt-[7px]': isOpen }"
          ></span>
          <span 
            class="w-full h-0.5 bg-primary_dark_blue block transition-all duration-300"
          ...
          <span 
            class="w-full h-0.5 bg-primary_dark_blue block transition-all duration-300"
            :class="{ '-rotate-45 mb-[10px]': isOpen }"
          ></span>
        </div>
      </button>
      ...
      >
      <SideNav :active-menu="activeMenu" :is-open=isOpen />
    </div>
    </div>
  </template>
